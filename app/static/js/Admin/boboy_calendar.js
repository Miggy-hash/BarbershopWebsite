document.addEventListener("DOMContentLoaded", () => {
  ...
  async function updateCalendar() {
    ...
    for (let i = firstDay; i > 0; i--) {
      ...
      prevDayDiv.className = "h-[50px] w-[auto] sm:h-[70px] md:h-[60px] lg:h-[90px] border border-gray-600 bg-gray-900 text-gray-500 p-1 rounded text-sm sm:text-sm md:text-base lg:text-lg xl:text-xl";
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      dayDiv.className = "h-[50px] w-[auto] sm:h-[70px] md:h-[60px] lg:h-[90px] border border-black bg-gray-200 p-1 rounded hover:bg-gray-400 hover:text-black hover:border-black cursor-pointer text-sm sm:text-sm md:text-base lg:text-lg xl:text-xl";
    ...
    for (let i = 1; i <= nextDays; i++) {
      ...
      nextDayDiv.className = "h-[50px] w-[auto] sm:h-[70px] md:h-[60px] lg:h-[90px] border border-gray-600 bg-gray-900 text-gray-500 p-1 rounded text-sm sm:text-sm md:text-base lg:text-lg xl:text-xl";
